...
# Tabela virtual, onde sua função é que o usuário tenha vizualização
# de ambas tabelas(categorias, movimentos).
# Selecionando os principais campos, onde o valor da movimentação é somado,
# fazendo inner join das tabelas, agrupando pelos campos 
